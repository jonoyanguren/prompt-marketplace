...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newCategory, savedCategory, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
...
var update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, updatedCategory, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                if (!id) {
                    return [2 /*return*/, res.status(400).json({ message: "Category id is required" })];
                }
                return [4 /*yield*/, category_model_1.default.findByIdAndUpdate(id, req.body, {
                        new: true,
                    })];
            case 1:
